...
or use the `identity server authentication handler <https://github.com/IdentityServer/OpenIdentityServer.AccessTokenValidation>`_ which can validate both JWTs and reference tokens.
