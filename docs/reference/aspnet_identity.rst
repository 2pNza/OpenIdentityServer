...
The repo for this support is located `here <https://github.com/IdentityServer/OpenIdentityServer.AspNetIdentity/>`_ and the NuGet package is `here <https://www.nuget.org/packages/OpenIdentityServer.AspNetIdentity>`_.
