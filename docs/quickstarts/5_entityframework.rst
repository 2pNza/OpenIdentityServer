...
.. Note:: You can find the `latest SQL scripts <https://github.com/IdentityServer/OpenIdentityServer/tree/main/src/EntityFramework.Storage/migrations/SqlServer/Migrations>`_ for SqlServer in the OpenIdentityServer.EntityFramework.Storage repository.
