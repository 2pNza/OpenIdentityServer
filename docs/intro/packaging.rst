...
^^^^^^^^^^^^^^^
`github <https://github.com/identityserver/OpenIdentityServer>`_
...
Quickstart UI
^^^^^^^^^^^^^
`github <https://github.com/IdentityServer/OpenIdentityServer.Quickstart.UI>`_

Contains a simple starter UI including login, logout and consent pages.

Access token validation handler
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
`nuget <https://www.nuget.org/packages/OpenIdentityServer.AccessTokenValidation>`_ | `github <https://github.com/IdentityServer/OpenIdentityServer.AccessTokenValidation>`_
...
Templates
^^^^^^^^^
`nuget <https://www.nuget.org/packages/OpenIdentityServer.Templates>`_ | `github <https://github.com/IdentityServer/OpenIdentityServer.Templates>`_
